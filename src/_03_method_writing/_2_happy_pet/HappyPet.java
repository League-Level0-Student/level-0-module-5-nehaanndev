...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		while ( happinessLevel <= 100) {
			...
			int task = JOptionPane.showOptionDialog(null, "What do you want to make you pet enjoy life?", "Pet Happiness!", 0, JOptionPane.INFORMATION_MESSAGE, null,
					new String[] { "groom", "talk a walk", "food", "water", "pet" }, null);

			// 6. Use user input to call the appropriate method created in step 5 below.
			groom(petType, happinessLevel);
	...
	public static int groom (String p, int happinessLevel) {
		if (p.equals("dog")) {
			...
			JOptionPane.showMessageDialog(null, "Your pet wants more.");
		}
